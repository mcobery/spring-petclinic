...
class PetControllerTests {
  ...
  @MockitoBean private OwnerRepository owners;

  @MockitoBean private PetTypeRepository types;
  ...
  class ProcessCreationFormHasErrors {
    ...
    void testProcessCreationFormWithInvalidBirthDate() throws Exception {
      ...
      mockMvc
          ...
          .andExpect(
              model().attributeHasFieldErrorCode("pet", "birthDate", "typeMismatch.birthDate"))
          .andExpect(status().isOk())
          .andExpect(view().name("pets/createOrUpdatePetForm"));
    }
